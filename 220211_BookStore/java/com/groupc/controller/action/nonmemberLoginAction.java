...
public class nonmemberLoginAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( nmvo == null ) {
	    ...
	    } else if( nmvo.getOd_pass().equals("")) {
	    	...
	    	session.setAttribute("nonmemberloginUser", nmvo);
	    	url="bs.do?cmd=nonmemberOrderList";
	    } else {
	    	request.setAttribute("message", "비회원 로그인이 실패했어요. 관리자에게 문의하세요");
	    }
