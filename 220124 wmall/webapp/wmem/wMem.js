...
function go_update(){
	if(document.upForm.um_pwd.value == ""){
		alert("update um_pwd none");
		document.upForm.um_pwd.focus();
	}else if(document.upForm.um_pwd.value != document.upForm.um_repwd.value){
		alert("um_pwd != um_repwd");
		document.upForm.um_repwd.focus();
	}else{
		document.upForm.action = "wm.do";
		document.upForm.submit();
	}
