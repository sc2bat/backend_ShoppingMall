...
SELECT * FROM wproduct WHERE kind='1';
SELECT * FROM wproduct WHERE kind=1;
SELECT * FROM wproduct WHERE kind=2;
SELECT * FROM wproduct WHERE kind=3;
SELECT * FROM wproduct WHERE kind=4;
SELECT * FROM wproduct WHERE kind=5;
