...
public class AdminMemberUseNListAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(avo == null) {
			...
			int count = adao.getAdminCount("member", "useyn", key);
			
			paging.setTotalCount(count);
			request.setAttribute("paging", paging);
			
			ArrayList<MemberVO> memberList = adao.getMemberUseNList(paging, key);
