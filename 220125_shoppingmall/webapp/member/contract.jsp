...
<article>
	...
	<form id="join" method="post" name="contractFrm">
		그룹 이름의 뜻은 from + idol + school = fromis (아이돌학교에서 왔다)의 줄임말이자 
		팬들에게 최고의 걸그룹이 되겠다는다는 약속[7]을 담은 것이며, 뒤에 붙은 9는 그룹의 멤버가 9명임을 의미한다.
		<br>		<br>
		<textarea rows="15" cols="100">제 1 장 총 칙
...
(1) "이용자" 또는”회원”이란 "Shoew Shop"에 접속하여 본 약관에 따라 "Shoew Shop"에 가입하여, 이용 고객의 식별과 이용고객의 서비스 이용을 위하여 이용고객 본인이 직접 선정하고 회사가 부여하는 문자와 숫자 조합인 ‘이용자번호(ID)’와 그에 따라 일치된 이용고객임을 확인하기 위하여 이용고객 본인이 선정한 ‘비밀번호’를 이용하여 "Shoew Shop"이 제공하는 서비스를 받는 자를 말합니다.
...
(1) 이용계약은 이용고객의 본 이용약관 내용에 대한 동의와 이용신청에 대하여 회사의 이용승낙으로 성립하여 이용약관에 대한 동의는 이용신청 당시 해당 Shoew Shop 웹의 '동의함' 버튼을 누름으로써 의사표시를 합니다.
...
회사는 관련법령이 정하는 바에 따라서 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의 개인정보보호에 관해서는 관련법령 및 "Shoew Shop"이 정하는 "개인정보보호정책"에 정한 바에 의합니다.
...
(3) ‘Shoew Shop’의 이용자ID는 이용자 본인의 동의하에 ‘Shoew Shop’ 가 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.
...
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시 중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시 중단은 Shoew Shop 웹을 통해 사전에 공지합니다.
...
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 Shoew Shop 웹 내의 [도움말] 메뉴를 이용해 가입해지를 해야 합니다.
...
(14) 회사는 회원이 Shoew Shop을 이용함으로써 회원 본인 또는 제3자에게 직/간접적으로 영향을 미치게 되는 모든 피해와 법적 문제에 대하여 책임을 지지 않습니다.
