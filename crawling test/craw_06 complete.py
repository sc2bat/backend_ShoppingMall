...
url = 'http://www.yes24.com/24/Category/Display/001001046011?PageNumber=23'
...
df=pd.DataFrame({"bname":bnameList,
                ...
                "price":priceList,
                "content":contentList,})
df.to_excel('C:/Users/PC/Desktop/qwer/220217/crawling test/bookList/booklistpage23.xlsx',index=False)